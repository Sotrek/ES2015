...
var Post = {
    findAll: function findAll() {
        return _api2.default.fetch("user_profile");
    }
};
...
var ui = {
    renderPosts: function renderPosts(user_profiles) {
        var elements = user_profiles.map(function (user_profile) {
            var first_name = user_profile.first_name,
                ...
                experience_months = user_profile.experience_months,
...
function articleTemplate(first_name, last_name, email, gender, Job_title, company, location, experience_years, experience_months, role) {
    var safeName = _xssFilters2.default.inHTMLData(first_name);
    var safeSurname = _xssFilters2.default.inHTMLData(last_name);
    var safeEmail = _xssFilters2.default.inHTMLData(email);
    var safeGender = _xssFilters2.default.inHTMLData(gender);
    var safeJTitle = _xssFilters2.default.inHTMLData(Job_title);
    var safeCompany = _xssFilters2.default.inHTMLData(company);
    var safeLocation = _xssFilters2.default.inHTMLData(location);
    var safeExperienceYears = _xssFilters2.default.inHTMLData(experience_years);
    var safeExperienceMonths = _xssFilters2.default.inHTMLData(experience_months);
    var safeRole = _xssFilters2.default.inHTMLData(role);
